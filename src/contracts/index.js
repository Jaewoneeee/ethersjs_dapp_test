...
const INFURA_ID = '';
const provider2 = new ethers.providers.JsonRpcProvider(`https://testnet-rpc-seoul.gen.foundation/${INFURA_ID}`)

// 씨이이이이바바바아아아알ㄹ 이게 지금 메타마스크에 연결된? 그걸로 signer가 되는것같음 ㅇㅇ 괜히 위에 gen쪽으로 연결했다가..
const provider = new ethers.providers.Web3Provider(window.ethereum)

//const wallet = new ethers.Wallet(privkey, provider);

const signer = provider.getSigner()
//const signer = provider.getSigner("0xb7aCF971835B8B58919d65B6A1f481b204303BF9")

const mintAnimalTokenAddress = '0xFf43F95F1B33440983057DF5B44d414ADAAB8C94'; //contract address
...
const saleAnimalTokenAddress = '0x0EcbDf8477dB855E38a5FdE37aeB9f3a951D72dD';
...
const saleContract = new ethers.Contract(saleAnimalTokenAddress, saleAnimalTokenAbi, signer);

export {mintContract, saleContract, saleAnimalTokenAddress, signer, provider, provider2}